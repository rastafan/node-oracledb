...
async function _verifyOptions(options, inCreatePool) {
  ...
  // sslRejectUnauthorized must be a boolean
  if (options.sslRejectUnauthorized !== undefined) {
    errors.assertParamPropValue(typeof options.sslRejectUnauthorized === 'boolean',
      1, "sslRejectUnauthorized");
    outOptions.sslRejectUnauthorized = options.sslRejectUnauthorized;
  }
